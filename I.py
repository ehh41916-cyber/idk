...
ID = input('\x1b[1;96mID : ')
print("")
TOKEN = input('\x1b[1;31mToken : ')
os.system('clear')

def update_stats():
    sysdontwrite = f"""\r
    {P}Good: {hits}{Z} | Bad : {bad_insta}{P} | Bad : {bad_email}{Z} | Neutral: {good_ig}"""
...
Hit Instagram .
━━━━━━━━━━━━━━━━━━━━━━━
</b>Account: {total_hits}</b>  
━━━━━━━━━━━━━━━━━━━
</b>Username: {username}</b>
━━━━━━━━━━━━━━━━━━━
</b>Email: {username}@{domain}</b> 
━━━━━━━━━━━━━━━━━━━
...
━━━━━━━━━━━━━━━━━━━
</b>Reset Info: {rest(username)}</b> 
━━━━━━━━━━━━━━━━━━━━━━━
</b>Py - EAN • @Xiil6 </b> 
"""
    with open('psb.txt', 'a') as f:
        f.write(info_text + "\n")
    try:
