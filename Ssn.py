...
import sys
import webbrowser
webbrowser.open("https://t.me/pytho1n")
print("اشترك في القناه لكي لاتواجه مشاكل")
...
output = render('@W4_M4', colors=['blue', 'green','yellow'], align='center')
print(F+'▬'*60)
print(output)
Op = "@W4_M4"
...
os.system('clear') 
import webbrowser
webbrowser.open("https://t.me/astorawew")
print("اشترك في القناه لكي لاتواجه مشاكل")
